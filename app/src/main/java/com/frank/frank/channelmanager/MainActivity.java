package com.frank.frank.channelmanager;
...
import com.frank.frank.channelmanager.drag.ChannelItem;
import com.frank.frank.channelmanager.drag.DragAdapter;
import com.frank.frank.channelmanager.drag.DragGrid;
import com.frank.frank.channelmanager.drag.OtherAdapter;
import com.frank.frank.channelmanager.drag.OtherGridView;
...
public class MainActivity extends Activity {
    ...
    private void initDatas() {
        ...
        //默认
        userChannelList.add(new ChannelItem(0 , "群组", 0, 0));
        userChannelList.add(new ChannelItem(0 , "动态", 0, 0));
        userChannelList.add(new ChannelItem(0 , "模拟组合", 0, 0));
        userChannelList.add(new ChannelItem(0 , "文章", 0, 0));
        ...
        otherChannelList.add(new ChannelItem(0 , "炒股学堂", 0, 0));
        otherChannelList.add(new ChannelItem(0 , "决策", 0, 0));
        ...
        userGridView.setMyOnItemLongClickListener(new DragGrid.MyOnItemLongClickListener() {
            @Override
            public void longClick() {
                if(!isModify) {
                    isModify = true;
                    userAdapter.setShowFlag(isModify);
                    operator.setText("完成");
    ...
    private void initViews() {
        ...
        tvZhuan = (TextView) findViewById(R.id.tv_zhuan);
    }
